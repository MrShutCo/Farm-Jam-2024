        ...
        private void OnEnable()
        {
            dialogue = new DialogueText(" Do you have any questions for me?", new()
            {
                new ("How do I bring back my husband?",
                    new DialogueText("You must gather enough resources to light the six pillars and complete the sacrifice", null)),
                new ("How do I collect resources?",
                    new DialogueText("First, there are two types of resources. Natural and human resources. Natural resources include Food, Wood, Steel, and Electronics. These will be used for building and upgrading machines", null,
                new DialogueText("Human resources include Blood, Bones, and Organs. These are used in sacrifices, and will give you various upgrades to yourself. Human resources are extracted by flaying humans", null))),
                ...
                new ("What are traits?", new DialogueText("Traits affect how good a person is at a particular skill. There's ranks F-S from worst to best.", null,
                    new DialogueText("TODO: put all traits here", null))),
